                ...
                default_messages = [
                    {
                        ...
                        "text": "Hi Bob, just wanted to update you on the project progress. We’re on track for the initial milestones and things are looking good so far. Let’s catch up later this week for further discussion.",
                        "id": "a1bc"
                    },
                    {
                        "messageId": 2,
                        ...
                        "text": "Hello Diana, just a reminder about our meeting scheduled for tomorrow at 10 AM. Please review the attached agenda and let me know if there’s anything specific you’d like to add.",
                        "id": "c8c5"
                    },
                    {
                        "messageId": 3,
                        "sender_email": "emma@example.com",
                        "receiver_email": "frank@example.com",
                        "subject": "Invoice Attached",
                        "text": "Dear Frank, I hope you’re doing well. Please find attached the invoice for the recent services rendered. Let me know if you have any questions or require further information.",
                        "id": "9975"
                    },
                    {
                        "messageId": 4,
                        "sender_email": "george@example.com",
                        "receiver_email": "harry@example.com",
                        "subject": "Weekly Report",
                        "text": "Hi Harry, here’s the weekly report summarizing the key metrics and updates. Please go through it and feel free to reach out if you’d like to discuss any particular points in detail.",
                        "id": "3b6d"
                    },
                    {
                        "messageId": 5,
                        "sender_email": "irene@example.com",
                        "receiver_email": "john@example.com",
                        "subject": "Feedback Request",
                        "text": "Hello John, we’d love to get your feedback on the recent changes we implemented. Your insights are valuable to us and will help us improve further. Please share your thoughts when you have a moment.",
                        "id": "cea1"
                    },
                    {
                        "messageId": 6,
                        "sender_email": "lucas@example.com",
                        "receiver_email": "mike@example.com",
                        "subject": "Project Proposal",
                        "text": "Hello Mike, I’ve attached the project proposal for your review. Please let me know if you’d like any changes or have any feedback before we finalize it.",
                        "id": "4904"
                    },
                    {
                        "messageId": 7,
                        "sender_email": "nina@example.com",
                        "receiver_email": "oliver@example.com",
                        "subject": "Lunch Meeting?",
                        "text": "Hi Oliver, are you available for lunch this Friday to discuss the upcoming event? Let me know if that works or if there’s a better time for you.",
                        "id": "fbfc"
                    },
                    {
                        "messageId": 8,
                        "sender_email": "paul@example.com",
                        "receiver_email": "quincy@example.com",
                        "subject": "Document Request",
                        "text": "Dear Quincy, could you send over the finalized documents from last week’s meeting? I need them for the monthly report due next Monday.",
                        "id": "72b7"
                    },
                    {
                        "messageId": 9,
                        "sender_email": "rachel@example.com",
                        "receiver_email": "steve@example.com",
                        "subject": "Travel Itinerary",
                        "text": "Hi Steve, I’ve sent over the itinerary for our upcoming trip. Please review and let me know if any adjustments are needed for the accommodations or flights.",
                        "id": "3406"
                    },
                    {
                        "messageId": 10,
                        "sender_email": "tina@example.com",
                        "receiver_email": "uma@example.com",
                        "subject": "Client Feedback",
                        "text": "Hello Uma, I received some feedback from the client regarding the recent deliverables. Let’s discuss it during our next meeting and decide on any necessary adjustments.",
                        "id": "80e0"
                    },
                    {
                        "messageId": 11,
                        "sender_email": "victor@example.com",
                        "receiver_email": "wendy@example.com",
                        "subject": "Team Meeting Summary",
                        "text": "Hi Wendy, here’s the summary of today’s team meeting. Please go through it and let me know if you’d like any additional information on any of the discussed points.",
                        "id": "f6de"
                    },
                    {
                        "messageId": 12,
                        "sender_email": "xander@example.com",
                        "receiver_email": "yara@example.com",
                        "subject": "Resource Allocation",
                        "text": "Hello Yara, I’ve shared the resource allocation plan with you. Let’s review it together this week to ensure everyone is set up with what they need.",
                        "id": "2974"
                    },
                    {
                        "messageId": 13,
                        "sender_email": "zoe@example.com",
                        "receiver_email": "aaron@example.com",
                        "subject": "Event Planning Updates",
                        "text": "Dear Aaron, here are the latest updates on the event planning. Please take a look and let me know if you have any suggestions for the event timeline or guest list.",
                        "id": "2b47"
                    },
                    {
                        "messageId": 14,
                        "sender_email": "bella@example.com",
                        "receiver_email": "chris@example.com",
                        "subject": "Performance Review",
                        "text": "Hi Chris, your performance review is scheduled for next Thursday at 2 PM. Please prepare your self-evaluation beforehand and let me know if you have any questions.",
                        "id": "0534"
                    },
                    {
                        "messageId": 15,
                        "sender_email": "dan@example.com",
                        "receiver_email": "eva@example.com",
                        "subject": "Budget Proposal",
                        "text": "Hello Eva, I’ve completed the budget proposal for the next quarter. Please review it when you get a chance, and we can discuss any necessary adjustments.",
                        "id": "9dca"
                    }
                ]
...
def instructor_courses():
    ...
    courses = (
        db.session.query(Course.id, Course.course_title)
    ...
    return jsonify([{"courseId": c.id, "course_title": c.course_title} for c in courses])
...
def add_or_update_video():
    ...
    if video_id:
        ...
        if video:
            ...
            db.session.commit()
            return jsonify({"message": "Video updated successfully", "videoid": video_id, "status:": video.status}), 200
        else:
